...
@once
  ...
  .wow-therapy-card-scope .title{ margin:0 0 6px; font-size: var(--title); font-weight:400; line-height:1.12; margin-top:10px; display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; overflow:hidden; font-family: 'Manrope', var(--bs-font-sans-serif) }
  ...
  .wow-therapy-card-scope .content-bottom{ flex:0 0 auto; margin-top:auto; padding-top:10px; border-top:1px solid rgba(16,24,40,.10); background:#fff }
