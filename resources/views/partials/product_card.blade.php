...
@once
  ...
  .wow-therapy-card-scope .content-bottom{ flex:0 0 auto; margin-top:auto; padding: padding: var(--padContentY) var(--padContentX); border-top:1px solid rgba(16,24,40,.10); background:#fff }
