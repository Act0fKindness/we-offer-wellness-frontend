...
<article class="wow49-store-blade" aria-label="Product card {{ $title }}">
    ...
    <footer><div><small>Price</small><strong>{{ $priceLabel }}</strong></div><a href="{{ $url }}">VIEW PRODUCT</a></footer>
</article>
