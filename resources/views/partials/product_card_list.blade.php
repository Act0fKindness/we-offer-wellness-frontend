...
@once
  <style>
    ...
    .wow-row-card{ background:var(--card); border:1px solid rgba(16, 24, 40, .18); border-radius:4px; box-shadow:var(--shadow); overflow:hidden; display:grid; height: var(--rowH);
