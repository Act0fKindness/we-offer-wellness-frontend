...
@once
  @push('head')
    <style>
      ...
      .wow-therapy-card-scope .list-aside{ width:240px; flex:0 0 240px; border-left:1px solid rgba(16,24,40,.10); background:#fff; padding: var(--pad); display:flex; flex-direction:column; justify-content:space-between; gap:12px }
