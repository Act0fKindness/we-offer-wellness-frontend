...
<div class="wow-acc-item">
  ...
  <div id="wowAvailability" class="collapse">
    <div class="wow-acc-body">
      ...
      @else
        <p class="wow-paragraph">Your voucher is valid for 12 months from the date of purchase. Please book and take your experience before the expiry date.</p>
        <p class="wow-paragraph">This experience is available 7 days a week (subject to practitioner availability).</p>
        <p class="wow-paragraph">We recommend booking at least 2–4 weeks in advance to ensure your preferred slots are available.</p>
        <p class="wow-paragraph">Please allow up to 60 minutes for the full experience (plus a few minutes to settle in).</p>
      @endif
    </div>
  </div>
</div>
