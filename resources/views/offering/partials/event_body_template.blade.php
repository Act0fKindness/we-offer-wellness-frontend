@php
    ...
    $gridArticles = $relatedArticles->slice(4, 4)->values();
    $gridDisplayArticles = $gridArticles->isNotEmpty() ? $gridArticles : $relatedArticles->slice(1, 4)->values();
@endphp
...
<style>
    ...
    .festival-page .our-vibe-section {
        position: relative;
        overflow: hidden;
    ...
    .festival-page .our-vibe-container {
        position: relative;
        z-index: 1;
    ...
    .festival-page .wow-section-heading {
        display: grid;
    ...
    .festival-page .wow-section-heading h2 {
        max-width: 1030px;
        margin: 0;
        color: #101828;
    ...
    .festival-page .wow-section-heading p {
        max-width: 680px;
        margin: 16px 0 0;
        color: #596275;
        font-size: 17px;
    ...
    .festival-page .wow-mindful-cta {
        align-self: end;
        white-space: nowrap;
    }

    .festival-page .wow-news-board {
        display: grid;
    ...
    .festival-page .wow-lead-story,
    .festival-page .wow-editor-list,
    .festival-page .wow-article-card {
        background: rgba(255,255,255,0.98);
        border: 1px solid #dfe4ea;
        box-shadow: 0 14px 42px rgba(16,24,40,.055);
    }

    .festival-page .wow-link {
        color: inherit;
        text-decoration: none;
    }
    ...
    .festival-page .wow-lead-media img,
    .festival-page .wow-article-image img,
    .festival-page .wow-editor-thumb img {
        width: 100%;
        height: 100%;
        display: block;
        object-fit: cover;
    ...
    .festival-page .wow-lead-media::after {
        content: "Featured";
        position: absolute;
        left: 18px;
        top: 18px;
    ...
    .festival-page .wow-lead-content {
        display: flex;
    ...
    .festival-page .wow-news-pill--red {
        background: #f6d5dc;
        color: #8f1532;
        border: 1px solid rgba(143, 21, 50, 0.16);
    }

    .festival-page .wow-lead-content h3 {
        margin: 0;
        color: #101828;
        font-family: "Playfair Display", Georgia, "Times New Roman", serif;
    ...
    .festival-page .wow-lead-content p {
        max-width: 560px;
        margin: 18px 0 0;
        color: #596275;
        font-size: 16px;
    ...
    .festival-page .wow-story-footer {
        display: flex;
        align-items: center;
        justify-content: space-between;
        gap: 18px;
    ...
    .festival-page .wow-editor-head {
        padding: 20px;
        border-bottom: 1px solid #edf0f2;
    }

    .festival-page .wow-editor-head h3 {
        margin: 0;
        color: #101828;
        font-size: 18px;
        line-height: 1.2;
    ...
    .festival-page .wow-editor-head p {
        margin: 8px 0 0;
        color: #667085;
        font-size: 13px;
        line-height: 1.45;
    ...
    .festival-page .wow-editor-item:last-child { border-bottom: 0; }
    .festival-page .wow-editor-item:hover { background: #f8fafc; }

    .festival-page .wow-editor-thumb {
        width: 76px;
        height: 58px;
        overflow: hidden;
        border-radius: 8px;
    ...
    .festival-page .wow-editor-item strong {
        display: block;
        color: #101828;
        font-size: 14px;
        line-height: 1.25;
    ...
    .festival-page .wow-editor-item span {
        display: block;
        margin-top: 6px;
        color: #8f1532;
        font-size: 12px;
    ...
    .festival-page .wow-article-grid {
        display: grid;
    ...
    .festival-page .wow-article-card:hover {
        transform: translateY(-2px);
        border-color: rgba(79, 147, 129, 0.42);
    }

    .festival-page .wow-article-image {
        height: 190px;
        overflow: hidden;
        background: #eef2f4;
    }

    .festival-page .wow-article-body {
        padding: 18px;
    }

    .festival-page .wow-article-body h3 {
        min-height: 58px;
        margin: 12px 0 0;
        color: #101828;
        font-size: 20px;
    ...
    .festival-page .wow-article-body p {
        margin: 10px 0 0;
        color: #667085;
        font-size: 14px;
        line-height: 1.5;
...
@if($relatedArticles->isNotEmpty())
    <style>
        ...
        #mindful-times .wow-coverage-rail{
            background:rgba(255,255,255,0.98);
            border:1px solid #dfe4ea;
            box-shadow:0 14px 42px rgba(16,24,40,.055);
        }
        ...
        #mindful-times .wow-coverage-rail-head{
            padding:18px 20px;
            border-bottom:1px solid #edf0f2;
        }
        #mindful-times .wow-coverage-rail-head h3{
            margin:0;
            color:#101828;
            font-size:18px;
            line-height:1.2;
        ...
        #mindful-times .wow-coverage-rail-head p{
            margin:8px 0 0;
            color:#667085;
            font-size:13px;
            line-height:1.45;
        }
        #mindful-times .wow-coverage-list{
            display:grid;
            gap:0;
            flex:1;
        }
        ...
        #mindful-times .wow-coverage-item:last-child{
            border-bottom:0;
        }
        #mindful-times .wow-coverage-item:hover{
            background:#f8fafc;
        }
        ...
        #mindful-times .wow-coverage-thumb img{
            width:100%;
            height:100%;
            object-fit:cover;
            display:block;
        }
        #mindful-times .wow-coverage-copy{
            min-width:0;
        }
        #mindful-times .wow-coverage-copy strong{
            display:block;
            color:#101828;
            font-size:14px;
            line-height:1.25;
        ...
        #mindful-times .wow-coverage-copy span{
            display:block;
            margin-top:6px;
            color:#667085;
            font-size:12px;
    ...
    <section class="wow-mindful-times-section our-vibe-section" aria-label="OUR VIBE articles and coverage" id="mindful-times">
        <div class="wow-mindful-container our-vibe-container">
            ...
            <div class="wow-news-board">
                ...
                <a class="wow-lead-story wow-link" href="{{ $featuredHref }}" target="_blank" rel="noopener" id="mindful-times-featured" aria-label="Featured article: {{ $featuredTitle }}">
                    <div class="wow-lead-media">
                        @if($featuredImage !== '')
                            <img src="{{ $featuredImage }}" alt="{{ $featuredTitle }}" loading="lazy">
                        @endif
                    </div>
                    ...
                    <div class="wow-lead-content">
                        <div>
                            <div class="wow-news-meta">
                                ...
                                <span class="wow-news-pill">{{ $featuredCategory }}</span>
                            </div>
                ...
                <aside>
                    <div class="wow-coverage-rail" aria-label="More coverage">
                        ...
                        <div class="wow-coverage-list">
                            @forelse($editorArticles as $article)
                                @php
                                    $editorImage = (string) data_get($article, 'image', '');
                                    $editorTitle = (string) data_get($article, 'title', 'Untitled story');
                                    $editorHref = (string) data_get($article, 'href', '#');
                                    $editorCategory = (string) data_get($article, 'category', 'Mindful Times');
                                    $editorExcerpt = (string) data_get($article, 'excerpt', '');
                                @endphp
                                <a href="{{ $editorHref }}" class="wow-coverage-item" target="_blank" rel="noopener">
                                    <div class="wow-coverage-thumb">
                                        @if($editorImage !== '')
                                            <img loading="lazy" src="{{ $editorImage }}" alt="{{ $editorTitle }}">
                                        @endif
                                    </div>
                            ...
                            @empty
                                <div class="wow-empty">No related stories available right now.</div>
                            @endforelse
                        </div>
                    </div>
                </aside>
            ...
            <div class="wow-article-grid" aria-label="Latest articles" id="mindful-times-article-grid">
                @forelse($gridDisplayArticles as $article)
                    @php
                        $gridImage = (string) data_get($article, 'image', '');
                        $gridTitle = (string) data_get($article, 'title', 'Untitled story');
                        $gridExcerpt = (string) data_get($article, 'excerpt', '');
                        $gridHref = (string) data_get($article, 'href', '#');
                        $gridCategory = (string) data_get($article, 'category', 'Mindful Times');
                    @endphp
                    <a href="{{ $gridHref }}" class="wow-article-card wow-link" target="_blank" rel="noopener">
                        <div class="wow-article-image">
                            @if($gridImage !== '')
                                <img loading="lazy" src="{{ $gridImage }}" alt="{{ $gridTitle }}">
                            @endif
                        </div>
                        <div class="wow-article-body">
                            <span class="wow-news-pill{{ $loop->first ? ' wow-news-pill--red' : '' }}">{{ $gridCategory }}</span>
                            <h3>{{ $gridTitle }}</h3>
                            <p>{{ $gridExcerpt }}</p>
                            <div class="wow-card-foot">
                                <span>Related coverage</span>
                                <strong>Read &rarr;</strong>
                            </div>
                        </div>
                    </a>
                @empty
