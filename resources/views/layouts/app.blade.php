...
<div id="app"
    ...
    <div data-v-cd6d8741="" class="lgate-overlay">
        <div data-v-cd6d8741="" class="lgate">
            <div data-v-cd6d8741="" class="lgate-header"><img data-v-cd6d8741=""
                                                              src="https://cdn.shopify.com/s/files/1/0820/3947/2469/files/logo.png?v=1738109013"
                                                              alt="We Offer Wellness"></div>
            <div data-v-cd6d8741="" class="lgate-body"><h3 data-v-cd6d8741="">Tailor your experience</h3>
                <p data-v-cd6d8741="" class="lead">Looking for <strong data-v-cd6d8741="">Online only</strong> or
                    <strong data-v-cd6d8741="">Online &amp; In‑person</strong> near you?</p>
                <div data-v-cd6d8741="" class="choice-row">
                    <button data-v-cd6d8741="" class="chip">Online only</button>
                    <button data-v-cd6d8741="" class="chip chip-brand">Online &amp; In‑person</button>
                </div>
                <div data-v-cd6d8741="" class="action-row">
                    <button data-v-cd6d8741="" class="btn btn-primary"><span data-v-cd6d8741="">Use my location</span>
                    </button>
                    <div data-v-cd6d8741="" class="muted">We’ll remember this and show nearby options first.</div>
                </div><!----></div>
        </div>
    </div>
 </div>
