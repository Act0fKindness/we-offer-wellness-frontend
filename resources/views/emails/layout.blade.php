        ...
        <table role="presentation" class="card" cellpadding="0" cellspacing="0">
          <tr>
            <td class="hero-top">
              <a href="https://weofferwellness.co.uk" target="_blank" rel="noopener">
                <img src="https://testing.studio.weofferwellness.co.uk/storage/uploads/images/6a14bf2a-e619-45ba-b63f-42e660ab3b0c.png" alt="We Offer Wellness" height="33" style="height:33px; width:auto; display:block;">
              </a>
          ...
          <tr>
            <td class="content">
              ...
              <p class="muted" style="margin:0{{ !empty($hideFooterHelp) ? ';display:none;' : '' }}">Need help? Email <a href="mailto:support@weofferwellness.co.uk">support@weofferwellness.co.uk</a>. This inbox isn’t monitored.</p>
            </td>
          </tr>
          <tr>
            <td class="footer">
