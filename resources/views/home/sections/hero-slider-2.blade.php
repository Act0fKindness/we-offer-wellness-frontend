<section data-v-f43bb09d="" class="whero whero--s2">
  <div data-v-f43bb09d="" class="whero-radial whero-radial--s2" aria-hidden="true"></div>
    ...
    <div data-v-f43bb09d="" class="row align-items-center g-5">
      <div data-v-f43bb09d="" class="col-12 col-lg-7">
        ...
        <p data-v-f43bb09d="" class="whero-sub mt-3 whero-sub--s2">
          ...
          <span data-v-f43bb09d="" class="whero-subline whero-subline--s2">
            Curated by practitioners — so it feels safe, simple, and genuinely helpful.
          </span>
        </p>

        <div class="whero-cta mt-4 whero-cta--s2">
          <a href="/online" class="btn-wow btn-md btn-arrow" data-loader-init="1">
            <span class="btn-label">Browse Online</span>
          ...
          <a href="/near-me" class="btn-wow btn-md" style="margin-left:10px;">
      ...
      <div data-v-f43bb09d="" class="col-12 col-lg-5">
        ...
        {{-- IMPORTANT: no includes of slide 1. Just paste the existing right-side panel block. --}}
      </div>
    </div>
  </div>
</section>
