...
const props = defineProps({
  ...
  badges: { type: Array, default: () => [ { icon: 'bi-award', text: 'Top rated' } ] },
  typeLabel: { type: String, default: 'Workshop • In-studio' },
  title: { type: String, required: true },
  rating: { type: [String, Number], default: '4.8' },
  hasReviews: { type: Boolean, default: true },
  reviewsText: { type: String, default: 'Great • 42 reviews' },
  meta: { type: Array, default: () => [
    { icon: 'bi-geo-alt', text: 'London Bridge' },
    { icon: 'bi-alarm', text: '90 mins' },
    { icon: 'bi-calendar3', text: 'Sat 10:30' },
  ] },
  policyText: { type: String, default: 'Free cancellation 24h' },
  price: { type: String, default: '£39.00' },
  priceNote: { type: String, default: '/ one-off' },
  ctaLabel: { type: String, default: 'Book Workshop' },
...
<template>
  <article :class="['wow-card', props.size === 'md' ? 'md' : '', 'workshop']" data-type="workshop">
    <div class="wow-media">
